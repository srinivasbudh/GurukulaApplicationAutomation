Feature: Register a new user
 ...
 @VerifyRegistrationIsNotPossibleIfAllMandatoryFieldsAreFilled @Regression
 ...
 @ValidRegistrationOfAUser @Regression
 ...
 @RegisterUserWithDifferentPasswords @Regression
